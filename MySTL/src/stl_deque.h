...
{
public:
    FRIEND_TEST(deque_iterator, All);
...
//        catch (...)
//        {
//            M_destroy(M_finish.M_node + 1, new_finish.M_node + 1);
//            throw;
//        }
//    }
//}
...
//            M_destroy(M_start.M_node, new_start.M_node);
//            M_start = new_start;
//        }
//        else
//        {
...
//    {
//        destroy(*node, *node + S_buffer_size());
...
//        M_deallocate_node(M_finish.Mfirst);
//    }
//    else
...
//            uninitialized_fill(*cur, *cur + S_buffer_size(), value);
//        uninitialized_fill(M_finish.M_first, M_finish.M_cur, value);
//    }
//    catch (...)
//    {
//        destroy(M_start, iterator(*cur, cur));
//        throw;
//    }
//}
//
...
//template <class Tp, class Alloc>
//void deque<Tp, Alloc>::M_push_front_aux(const value_type &)
//{
//    value_type t_copy = t;
//    M_reserve_map_at_back();
...
//
//template <class Tp, class Alloc>
//typename deque<Tp, Alloc>::iterator deque<Tp, Alloc>::M_insert_aux(iterator pos, const value_type& x)
//{
//    difference_type index = pos - M_start;
//    value_type x_copy = x;
...
//
//template <class Tp, class Alloc>
//void deque<Tp, Alloc>::M_insert_aux(iterator pos, const value_type* first, const value_type* last, size_type n)
//{
...
//            else
//            {
//                const value_type* mid = first + (difference_type(n) - elemsbefore);
...
//            else
//            {
//                const value_type* mid = first + elemsafter;
...
//void deque<_Tp,_Alloc>::M_insert_aux(iterator pos, const_iterator first, const_iterator last, size_type n)
//{
//    const difference_type elemsbefore = pos - M_start;
//    size_type length = size();
//    if (elemsbefore < length / 2) {
...
//            if (elemsbefore >= n)
//            {
//                iterator __start_n = M_start + n;
//                uninitialized_copy(M_start, __start_n, new_start);
//                M_start = new_start;
//                copy(__start_n, pos, old_start);
//                copy(first, last, pos - difference_type(n));
//            }
//            else
//            {
//                const_iterator __mid = first + (n - elemsbefore);
//                __uninitialized_copy_copy(M_start, pos, first, __mid,
//                                          new_start);
//                M_start = new_start;
//                copy(__mid, last, old_start);
//            }
//        }
//        catch (...)
//        {
//            M_destroy_nodes(new_start._M_node, M_start.M_node);
//            throw;
//        }
//    }
//    else {
...
//        const difference_type __elemsafter = length - elemsbefore;
//        pos = M_finish - __elemsafter;
//        try
//        {
//
//            if (__elemsafter > n)
//            {
//                    iterator __finish_n = M_finish - difference_type(n);
//                    uninitialized_copy(__finish_n, M_finish, M_finish);
//                    M_finish = new_finish;
//                    copy_backward(pos, __finish_n, __old_finish);
//                    copy(first, last, pos);
//                }
//                else
//                {
//                    const_iterator __mid = first + __elemsafter;
//                    __uninitialized_copy_copy(__mid, last, pos, M_finish, M_finish);
//                    M_finish = new_finish;
...
//        catch (...)
//        {
//            _M_destroy_nodes(M_finish._M_node + 1, new_finish._M_node + 1);
//            throw;
//        }
//    }
//}
